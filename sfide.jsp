...
%>
    ...
    <section id="sfide" class="page-section">
                             ...
                             <%
                              ...
                              %>
                                <tr>
                                    ...
                                    <td>
                                        <form action="EliminaSfida">
                                            <input type="hidden" name="id" value="<%= sfida.getId() %>">
                                            <button type="submit" class="btn-action">ELIMINA</button>
                                        </form>
                                    </td> 
                                </tr>
                             <%
    	...
    	<div class="create-section">
	        <h2 style="color: white;">Vuoi creare una nuova sfida?</h2>
	        <a href="/privato/admin/richiediCreazioneSfida"><button class="btn-action">Crea Sfida</button></a>
   	 	</div>	
    </section>
